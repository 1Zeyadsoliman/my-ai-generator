    ...
    return (
      ...
      >
        ...
        <header className="px-10 py-32 grid lg:grid-cols-2 gap-20 max-w-7xl mx-auto items-center animate-in fade-in duration-700">
          <div>
            <h1 className="text-5xl md:text-3xl font-black mb-8 uppercase tracking-tighter italic whitespace-nowrap md:whitespace-normal overflow-x-auto md:overflow-visible">
